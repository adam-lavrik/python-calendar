...
def days_in_year(y):
    ...
    """
    return y and julian0.days_in_year(to_0_based(y))
...
def days_in_month(m):
    ...
    """
    return julian0.days_in_month(m)
...
def days_in_year_month(y, m):
    ...
    Invalid input data produces meaningless result.
    """
    return y and julian0.days_in_year_month(to_0_based(y), m)


def is_valid_date(y, m, d):
    """
    Return True if year, month and day represent valid Julian date
    (year 0 is invalid), False otherwise.
    """
    return y and julian0.is_valid_date(to_0_based(y), m, d)


def from_jdn(j):
    """
    Return Julian date of Julian day.
    """
    y, m, d = julian0.from_jdn(j)
...
def to_jdn(y, m, d):
    ...
    Invalid input data produces meaningless result.
    """
    return julian0.to_jdn(to_0_based(y), m, d)
...
def from_year_day(y, yd):
    ...
    Invalid input data produces meaningless result.
    """
    return julian0.from_year_day(to_0_based(y), yd)
...
def to_year_day(y, m, d):
    ...
    Invalid input data produces meaningless result.
    """
    return julian0.to_year_day(to_0_based(y), m, d)
...
def days_between(y0, m0, d0, y1, m1, d1):
    ...
    Invalid input data produces meaningless result.
    """
    return julian0.days_between(to_0_based(y1), m1, d1, to_0_based(y0), m0, d0)
